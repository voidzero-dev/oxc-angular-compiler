    ...
    try {
      ...
      if (!candidateFailed) {
        if (
          ...
          if (bindingPackageVersion !== '0.0.35') {
            throw new Error(
              `WASI binding package version mismatch, expected 0.0.35 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
            )
          }
        }
