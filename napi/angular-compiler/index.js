    ...
    try {
      ...
      if (!candidateFailed) {
        if (
          ...
          if (bindingPackageVersion !== '0.0.34') {
            throw new Error(
              `WASI binding package version mismatch, expected 0.0.34 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
            )
          }
        }
